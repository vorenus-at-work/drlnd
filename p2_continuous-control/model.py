"""From model.py file of DDPG exercise"""
# Change the models of Actor and Critic
import numpy as np
...
class Actor(nn.Module):
    ...
    def __init__(self, state_size, action_size, fc1_units=256, fc2_units=128, leak=0.01, seed=0):
    ...
    def reset_parameters(self):
        """Try use other methods"""
        #self.fc1.weight.data.uniform_(*hidden_init(self.fc1))
        #self.fc2.weight.data.uniform_(*hidden_init(self.fc2))
        #self.fc3.weight.data.uniform_(-3e-3, 3e-3)
        """Initialize with method proposed by He Kaiming"""
...
class Critic(nn.Module):
    ...
    def __init__(self, state_size, action_size, fcs1_units=256, fc2_units=128, fc3_units=128, leak=0.01, seed=0):
        """Initialize parameters and build model.
        Params
        ======
            state_size (int): Dimension of each state
