'''
Start from DDPG project functions, changed into ddpg_agent, 
which can be identified by agent_id.
'''
import numpy as np
import random
import copy
...
class Agent():
    ...
    # Compared to other projects, agent_id is different, since it is a MA game.
    def __init__(self, state_size, action_size, agent_id,random_seed):
        ...
        ======
            ...
            agent_id (int): identity for the agent
        ...
        # Same weights are initialized to actor and critic networks
        ...
        # Replay memory managed by other function now
        #self.memory = ReplayBuffer(action_size, BUFFER_SIZE, BATCH_SIZE, random_seed)

    ''' 
    # Replay buffer memory managed by others   
    ...
    def learn(self, experiences, next_actions,actions_pred):
        ...
        # Compute Q targets for current states (y_i) for agent_id
        ...
        # using critic to calculate actor loss
